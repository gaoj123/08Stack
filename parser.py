...
def parse_file( fname, edges, polygons, csstack, screen, color ):
    #Current coodinate system (top of stack) is at the end of the stack data structure
    f = open(fname)
    lines = f.readlines()
    step = 100
    step_3d = 20
    ...
    while c < len(lines):
        ...
        if line == 'sphere':
            ...
            ##top is end of list
            csstack.append(deepcopy(csstack[-1]))
        elif line=="pop":
            csstack.pop()
